                    ...
                    \begin{claim}
                        $M \otimes_A N \otimes_A \mathbb{K} \cong (M \otimes_A \mathbb{K}) \otimes_{\mathbb{K}} (N \otimes_A \mathbb{K})$ as $\mathbb{K}$-vector spaces.
                            \begin{proof}
                                ...
                                \[
                                    \bar{f}\left(\sum_{i, j} \overline{\lambda^i_j} \overline{m_i} \otimes_\mathbb{K} \overline{n_j} \right) = \sum_{i,j} f(\lambda^i_j m_i \otimes_A n_j)
                                \]
                                where lifting $\overline{\lambda^i_j}$ is fine because $\mathfrak{m}(M \otimes_A N) \subseteq \text{Ker } f$.
                                Checking that the diagram commutes is a matter of applying linearity of $f$, $\varphi$ and $\overline{\varphi}$, and the commutativity of the diagram for $\hat{\pi}$.
