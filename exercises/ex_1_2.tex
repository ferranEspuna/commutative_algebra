            ...
            \begin{sol}
                \begin{proof}
                    ...
                    \begin{itemize}
                        ...
                        \begin{claim}
                            Let $p \in Spec(A)$.
                            Then, $a_i \in p$ for all $i \in \{1, \cdots n\}$.
                            \begin{proof}
                                $p \in Spec(A)$ implies that $A/p$ is an integral domain.
                                Consider the reduction $\pi: A[T] \rightarrow A/p[T]$ that takes each element $a \in A[T]$ to the class $\bar{a} \in A/p[T]$.
                                It takes units $f$ to units $\bar{f}$.
                                We have that $0 = degree(\bar{f} \bar{f^{-1}}) = degree(\bar{f}) + degree(\bar{f^{-1}})$, and since $A/p$ is an integral domain $degree(\bar{f}) = degree(\bar{f^{-1}}) = 0$.
                                Thus, $\bar{f}$ is constant, and $a_i \in p$ for all $i \in \{1, \cdots n\}$.
                            \end{proof}
                        \end{claim}
                        Since the claim holds for all $p \in Spec(A)$, we have that $a_i \in \bigcap_{p \in Spec(A)}p$.
